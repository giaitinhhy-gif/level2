...
struct Button {
    ...
    std::string label;   // text hiển thị
    int value;           // giá trị trả về khi được click
};
...
class SDLRenderer : public I_Renderer {
   private:
    ...
    //void drawText(const std::string& text, int x, int y, SDL_Color color, int size = 24);
   ...
   public:
    ...
    void renderPresent();
    void drawRect(int x, int y, int w, int h, SDL_Color color, bool filled);
    void drawRoundRect(int x, int y, int w, int h, int r, SDL_Color color, bool filled);
    void drawText(const std::string& text, int x, int y, SDL_Color color, TTF_Font* font);
    void drawTextCentered(const std::string& text, int cx, int y, SDL_Color color, TTF_Font* font);
    void drawButton(const Button& btn, bool hovered = false);
    void drawButtons();
    void highlightHovered(int mx, int my);
    void drawNumberPicker(int value, int minVal, int maxVal);
